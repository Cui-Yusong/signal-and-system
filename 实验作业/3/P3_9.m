...
saveas(gcf, "./P3_9_e.png");
close;

%3_9_f

% y1
y1=(1/(1+1i))*apos_k(1)*exp(1i*t)+(1/(1+1i))*aneg_k(1)*exp(-1i*t);
ys1=lsim(b,a,s1,t);
subplot(5,2,1);
plot(t,y1)
xlim([10,20]);
